...
export default function Home(){
 ...
 <main className="wrap">
  ...
  <section id="contact"><div className="contact"><div><div className="eyebrow">05 / CONTACT</div><h2>Let’s build something useful.</h2><p>Open to technology, automation, AI integration, product and IT opportunities.</p></div><div className="card contact-card"><p><b>Hyderabad, Pakistan</b></p><p>sky z ai2009@gmail.com</p><p>linkedin.com/in/muhammd-shahbaz-khan-06429a377</p><p>github.com/Skyzai4u</p></div></div></section>
